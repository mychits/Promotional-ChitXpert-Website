        ...
        <ul className="hidden md:flex items-center space-x-1 text-white text-sm font-medium ml-6">
          ...
          >
            ...
            <button 
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg hover:bg-white/10 hover:text-white transition-all"
            >
                  ...
                  {featureMenu.map((item) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`px-5 py-3 cursor-pointer flex items-center justify-between text-sm transition-all select-none ${
                        ...
                        {item.children && (
                          <ChevronRight 
                            ...
                            className={`text-gray-400 transition-transform duration-200 ${
                              activeItem?.id === item.id ? "rotate-90 text-blue-600" : ""
                            }`} 
                          />
                        )}
                      </div>
          ...
          >
            ...
            >
              ...
              <ChevronDown size={14} className={`transition-transform duration-300 ${openMenu === "mobile" ? "rotate-180" : ""}`} />
            </button>
          ...
          {/* REPORTS DROPDOWN - CLICK + HOVER SUPPORT */}
          <li
            className="relative nav-item"
          ...
          >
            ...
            >
              <span>Reports</span>
              <ChevronDown size={14} className={`transition-transform duration-300 ${openMenu === "reports" ? "rotate-180" : ""}`} />
            </button>

            {/* MAIN DROPDOWN */}
            {openMenu === "reports" && (
              <div
                className="absolute left-0 top-full mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 animate-fadeIn max-h-[600px] overflow-y-auto"
                onMouseEnter={() => handleMouseEnter("reports")}
                onMouseLeave={handleMouseLeave}
              >
                <ul className="w-72 py-2">
          ...
          <li className="ml-3">
            <a
              href="/signup"
              className="inline-flex items-center justify-center whitespace-nowrap bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white px-6 py-2.5 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 group relative overflow-hidden"
            >

        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed font-medium">
              With Chit Fund Pvt Ltd, gain complete visibility into every rupee
              that enters and leaves your chit fund operations — all from a
            ...
            <ul className="space-y-5 mb-10">
              <li className="flex gap-4 items-start group">
                ...
                <div>
                  <strong className="block text-gray-900 text-lg">
                    Strategically Boost Profit Margins
                  </strong>
                  <span className="text-gray-500 text-sm">
                    Identify revenue opportunities and optimize performance.
                  </span>
                </div>
              </li>
              ...
              <li className="flex gap-4 items-start group">
                ...
                <div>
                  ...
                  <span className="text-gray-500 text-sm">
                    Manage members, payments, auctions, and communication.
                  </span>
                </div>
              </li>
              ...
              <li className="flex gap-4 items-start group">
                ...
                <div>
                  ...
                  <span className="text-gray-500 text-sm">
                    Faster workflows with secure multi-user access.
                  </span>
                </div>
              </li>
            </ul>
